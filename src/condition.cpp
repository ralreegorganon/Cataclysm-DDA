...
template struct conditional_t<condition_context>;
template void read_condition<condition_context>( JsonObject &jo, const std::string &member_name,
        std::function<bool( const condition_context & )> &condition, bool default_val );
