...
| `overmap_forest_settings`       | Defines paramters for generating forests and swamps in the region. |
...
|               Identifier               |                               Description                               |
| -------------------------------------- | ----------------------------------------------------------------------- |
| `noise_threshold_forest`               | Value [0, 1] for which a `forest` will spawn.                           |
| `noise_threshold_forest_thick`         | Value [0, 1] forwhich a `forest_thick` will spawn.                      |
| `noise_threshold_swamp_adjacent_water` | Value [0, 1] for which a `forest_water` near a waterbody will spawn.    |
| `noise_threshold_swamp_isolated`       | Value [0, 1] for which a `forest_water` isolated from water will spawn. |
